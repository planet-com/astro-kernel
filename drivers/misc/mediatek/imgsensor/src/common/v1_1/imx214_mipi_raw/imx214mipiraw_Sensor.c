...
#include "imx214_eeprom.h"

//#define IMX214_PDAF_ON
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R,		//SENSOR_OUTPUT_FORMAT_RAW_4CELL_HW_BAYER_R,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	{4208, 3120, 0000, 0000, 4208, 3120, 2104, 1560, 0000, 0000, 2104, 1560,	0,	  0, 2104, 1560}, /* Preview */
	{4208, 3120, 0000, 0000, 4208, 3120, 4208, 3120, 0000, 0000, 4208, 3120,	0,	  0, 4208, 3120}, /* capture */
	{4208, 3120, 0000, 0000, 4208, 3120, 2104, 1560, 0000, 0000, 2104,  1560,	0,	  0, 2104, 1560}, /* video */
	{4208, 3120, 0000, 0000, 4208, 3120, 2104, 1560, 0000, 0000, 2104, 1560,	0,	  0, 2104, 1560}, /* high speed video */
	{4208, 3120, 0000, 0000, 4208, 3120, 2104, 1560, 0000, 0000, 2104, 1560,	0,	  0, 2104, 1560}, /*  slim */
#if CUS1_12M_60_FPS
	{4208, 3120, 0000, 0000, 4208, 3120, 2104, 1560, 0000, 0000, 2104, 1560,	0,	  0, 2104, 1560}, /*  custom1 */
#else /*CUS1_12M_100_FPS*/
	{4208, 3120, 0000, 0000, 4208, 3120, 2104, 1560, 0000, 0000, 2104, 1560,	0,	  0, 2104, 1560}, /*  custom1 */
#endif
//	{4208, 3120, 0000, 0000, 4208, 3120, 2104, 1560, 0000, 0000, 2104, 1560,	0,	  0, 2104, 1560}, /* custom2 */
};	
...
#define IMX214MIPI_MaxGainIndex (223)
...
static void imx214_get_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void imx214_set_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
#ifdef IMX214_PDAF_ON
static void imx214_apply_LRC(void)
{
	...
	read_imx214_LRC(imx214_LRC_data);

	/* L LRC*/
	puSendCmd[0] = (char)(Lstart_reg >> 8);
	puSendCmd[1] = (char)(Lstart_reg & 0xFF);
	memcpy((void *)&puSendCmd[2], imx214_LRC_data, 192);
	...
	memcpy((void *)&puSendCmd[2], imx214_LRC_data + 192, 192);
	iBurstWriteReg_multi(puSendCmd, 194, imgsensor.i2c_write_id,
						194, imgsensor_info.i2c_speed);
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	for (i = 0; i < IMX214MIPI_MaxGainIndex; i++) {
		if(gain <= IMX214MIPI_sensorGainMapping[i][0]){
			break;
		}
	}
	if(gain != IMX214MIPI_sensorGainMapping[i][0])
		LOG_INF("Gain mapping don't correctly:%d %d \n", gain, IMX214MIPI_sensorGainMapping[i][0]);
	return IMX214MIPI_sensorGainMapping[i][1];
}
...
#endif
static kal_uint16 imx214_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
static kal_uint16 imx214_init_setting[] = {
	0x0136,0x18,
    0x0137,0x00,         
    0x0101,0x00,
    0x0105,0x01,
...
static kal_uint16 imx214_preview_setting[] = {
	//2104*1560@30fps
	0x0100,0x00,
    0x0114,0x01,
    0x0220,0x00,
...
/*************** add by eastaeon ******************/
static kal_uint16 imx214_capture_setting[] = {
		0x0100,0x00,
        0x0114,0x01,
        0x0220,0x00,
        0x0221,0x11,
...
#if 0
static kal_uint16 imx214_normal_video_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
	0x0342, 0x1E,
...
static kal_uint16 imx214_hs_video_setting[] = {
	/*MIPI output setting*/
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
...
static kal_uint16 imx214_slim_video_setting[] = {
	/*MIPI output setting*/
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
...
#if CUS1_12M_60_FPS
static kal_uint16 imx214_custom1_setting[] = {
	/*MIPI output setting*/
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
...
#if 0
static kal_uint16 imx214_custom2_setting[] = {
	/*MIPI output setting*/
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x02,
...
static void sensor_init(void)
{
	...
	imx214_table_write_cmos_sensor(imx214_init_setting,
		sizeof(imx214_init_setting)/sizeof(kal_uint16));
...
static void preview_setting(void)
{
	...
	imx214_table_write_cmos_sensor(imx214_preview_setting,
		sizeof(imx214_preview_setting)/sizeof(kal_uint16));
	LOG_INF("X");
} /* preview_setting */
...
#if 1
	imx214_table_write_cmos_sensor(imx214_capture_setting,
		sizeof(imx214_capture_setting)/sizeof(kal_uint16));
#else
	/*************MIPI output setting************/
	/*MIPI output setting*/
...
#if VIDEO_60_FPS
	LOG_INF("imx214 VIDEO_60_FPS\n");
	imx214_table_write_cmos_sensor(imx214_normal_video_setting_60fps,
		sizeof(imx214_normal_video_setting_60fps)/sizeof(kal_uint16));
#else
	LOG_INF("imx214 VIDEO_30_FPS\n");
	imx214_table_write_cmos_sensor(imx214_preview_setting,
		sizeof(imx214_preview_setting)/sizeof(kal_uint16));
#endif
	LOG_INF("X\n");
...
static void hs_video_setting(void)
{
	...
	imx214_table_write_cmos_sensor(imx214_hs_video_setting,
		sizeof(imx214_hs_video_setting)/sizeof(kal_uint16));
...
static void slim_video_setting(void)
{
	...
	imx214_table_write_cmos_sensor(imx214_slim_video_setting,
		sizeof(imx214_slim_video_setting)/sizeof(kal_uint16));
...
static void custom1_setting(void)
{
	...
	imx214_table_write_cmos_sensor(imx214_custom1_setting,
		sizeof(imx214_custom1_setting)/sizeof(kal_uint16));
...
static void custom2_setting(void)
{
	...
	LOG_INF("%s 30 fpsX\n", __func__);
#else
	imx214_table_write_cmos_sensor(imx214_custom2_setting, sizeof(imx214_custom2_setting)/sizeof(kal_uint16));
	LOG_INF("X");
#endif
}
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx214_get_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_SET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx214_set_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
