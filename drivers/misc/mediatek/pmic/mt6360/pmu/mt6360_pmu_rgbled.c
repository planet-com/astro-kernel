...
static const struct rgbled_reg_val rgbled_init_data[] = {
	...
	RGBLED_REG_VAL(0xc3,  MT6360_PMU_RGB1_ISNK), //0xca 20ma -> 0xc3 6ma
	RGBLED_REG_VAL(0xc3,  MT6360_PMU_RGB2_ISNK),
	RGBLED_REG_VAL(0xc3,  MT6360_PMU_RGB3_ISNK),
	RGBLED_REG_VAL(0x81,  MT6360_PMU_RGB_ML_ISNK), //0x8c 60ma -> 0x81 5ma
