...
/*****************************************************************************
*
* File Name: focaltech_upgrade_ft5682.c
*
...
/************************************************************************
* Name: fts_ft5682_upgrade
* Brief:
* Input:
* Output:
* Return: return 0 if success, otherwise return error code
***********************************************************************/
static int fts_ft5682_upgrade(u8 *buf, u32 len)
{
    int ret = 0;
    u32 start_addr = 0;
    u8 cmd[4] = { 0 };
    ...
    /* write app */
    start_addr = upgrade_func_ft5682.appoff;
...
struct upgrade_func upgrade_func_ft5682 = {
    .ctype = {0x87},
    .fwveroff = 0x010E,
    .fwcfgoff = 0x1F80,
    .appoff = 0x0000,
